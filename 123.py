...
wanted_dirs = []
header_dir_backtrace_level = 3
compile_commands_json = "compile_commands.json"

def is_header_file(file):
    return file.endswith(".h") or file.endswith(".hh") or file.endswith(".hpp")

def is_source_file(file):
    return file.endswith(".c") or file.endswith(".cc") or file.endswith(".cpp") or file.endswith(".c++") or file.endswith(".cxx") or file.endswith(".ipp")
